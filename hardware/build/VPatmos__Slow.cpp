...
VL_CTOR_IMP(VPatmos) {
    VPatmos__Syms* __restrict vlSymsp = __VlSymsp = new VPatmos__Syms(this, name());
...
void VPatmos::__Vconfigure(VPatmos__Syms* vlSymsp, bool first) {
...
void VPatmos::_initial__TOP__1(VPatmos__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPatmos::_initial__TOP__1\n"); );
    VPatmos* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->io_SRamCtrl_ramOut_nce = 0U;
}

void VPatmos::_settle__TOP__7(VPatmos__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPatmos::_settle__TOP__7\n"); );
    VPatmos* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->io_Leds_led = vlTOPp->Patmos__DOT__Leds__DOT__REG;
    vlTOPp->io_UartCmp_tx = vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__tx_reg;
    vlTOPp->io_SRamCtrl_ramOut_dout = (0xffffU & vlTOPp->Patmos__DOT__ramCtrl__DOT__doutReg);
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT___T_10 
        = (3U & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__burstCntReg)));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT___T_26 
        = (0x7ffU & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__fetchCntReg)));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT___T_88 
        = (0xfU & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__nextIndexReg)));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT___T_89 
        = ((0xfU == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__nextIndexReg))
            ? 0U : (0xfU & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__nextIndexReg))));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT___T_98 
        = (0xfU & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__nextTagReg)));
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT___T_50 
        = (0x1ffffffffULL & (4ULL + vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__transferAddrReg));
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__bp__DOT___T_10 
        = (3U & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__bp__DOT__burstCntReg)));
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__wc__DOT___T_6 
        = (3U & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__wc__DOT__cntReg)));
    vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT___T_17 
        = (0x1ffU & ((IData)(vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__tx_buff) 
                     >> 1U));
    vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT___T_19 
        = (0xaU == (IData)(vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__tx_counter));
    vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT___T_22 
        = ((0xaU == (IData)(vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__tx_counter))
            ? 0U : (0xfU & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__tx_counter))));
    vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__txQueue__DOT___value_T_3 
        = (0xfU & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__txQueue__DOT__deq_ptr_value)));
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__wc__DOT___GEN_12 
        = ((1U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__wc__DOT__state))
            ? ((3U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__wc__DOT__cntReg))
    ...
    vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__txQueue__DOT__ram_io_deq_bits_MPORT_data 
        = vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__txQueue__DOT__ram
        [vlTOPp->Patmos__DOT__UartCmp__DOT__uart__DOT__txQueue__DOT__deq_ptr_value];
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl_io_mcachefe_memSel 
        = (((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__selSpmReg) 
            << 1U) | (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__selCacheReg));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT___GEN_19 
        = ((0U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__stateReg))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__hitReg)
                ? vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__ocpAddrReg
                : (0xfffffffcU & (vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__callRetBaseReg 
                                  - (IData)(1U)))) : vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__ocpAddrReg);
    ...
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT___T_7 
    ...
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT___GEN_15 
        = ((0U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__stateReg))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__hitReg)
                ? (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__burstCntReg)
                : 0U) : (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__burstCntReg));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT___GEN_26 
        = ((3U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__burstCntReg))
            ? 0U : (3U & ((IData)(1U) + (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__burstCntReg))));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT___GEN_18 
        = ((0U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__stateReg))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__hitReg)
                ? ((QData)((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__ocpAddrReg)) 
                   << 2U) : ((QData)((IData)((0x3fffffffU 
                                              & ((vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__callRetBaseReg 
                                                  - (IData)(1U)) 
                                                 >> 2U)))) 
                             << 4U)) : ((QData)((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__ocpAddrReg)) 
                                        << 2U));
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___T_96 
        = (((((QData)((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__mulHHReg)) 
              << 0x20U) | (QData)((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__mulLLReg))) 
            + (((QData)((IData)((0x7fffU & (- (IData)(
                                                      (1U 
                                                       & (IData)(
                                                                 (vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__mulHLReg 
                                                                  >> 0x20U)))))))) 
                << 0x31U) | (vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__mulHLReg 
                             << 0x10U))) + (((QData)((IData)(
                                                             (0x7fffU 
                                                              & (- (IData)(
                                                                           (1U 
                                                                            & (IData)(
                                                                                (vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__mulLHReg 
                                                                                >> 0x20U)))))))) 
                                             << 0x31U) 
                                            | (vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__mulLHReg 
                                               << 0x10U)));
    ...
    vlTOPp->Patmos__DOT__CpuInfo__DOT___GEN_13 = ((1U 
                                                   == 
                                                   (0xfU 
                                                           ...
                                                           ((0xbU 
                                                            ...
                                                            ((0xcU 
                                                             ...
                                                             ((0xdU 
                                                               ...
                                                               ? 0x800U
                                                               : 0U)))))))))))));
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock_3__DOT__mem_MPORT_1_data 
        = vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock_3__DOT__mem
        [vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock_3__DOT__rdAddrReg];
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT___T_1 
        = ((vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock_2__DOT__mem
            [vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock_2__DOT__rdAddrReg] 
            << 0x10U) | ((vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock_1__DOT__mem
                          [vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock_1__DOT__rdAddrReg] 
                          << 8U) | vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock__DOT__mem
                         [vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__MemBlock__DOT__rdAddrReg]));
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___GEN_128 
        = ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_3)
            ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_1
            : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_0);
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___T_54 
        = ((2U & (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwReg_3))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_3)
                ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_1
                : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_0)
            : ((4U & (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwReg_3))
                ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exReg_immVal_1
                : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exReg_rsData_3));
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___GEN_124 
        = ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_2)
            ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_1
            : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_0);
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___T_48 
        = ((2U & (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwReg_2))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_2)
                ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_1
                : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_0)
            : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exReg_rsData_2);
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT___GEN_16 
        = ((0U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__stateReg))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__repl__DOT__hitReg)
                ? (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__ocpCmdReg)
                : 2U) : (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__ocpCmdReg));
    vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl_io_illMem 
        = ((3U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__stateReg)) 
           & (3U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__icache__DOT__ctrl__DOT__burstCntReg)));
    vlTOPp->Patmos__DOT__cores_0__DOT__memory_io_exc_src 
        = ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__memory__DOT__memReg_mem_illOp)
            ? 0U : ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__memory__DOT__illMemReg)
                     ? 1U : (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__memory__DOT__memReg_mem_xsrc)));
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___GEN_120 
        = ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_1)
            ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_1
            : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_0);
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___T_44 
        = ((2U & (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwReg_1))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_1)
                ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_1
                : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_0)
            : ((4U & (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwReg_1))
                ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exReg_immVal_0
                : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exReg_rsData_1));
    vlTOPp->Patmos__DOT__cores_0__DOT__fetch__DOT__MemBlock__DOT__mem_MPORT_1_data 
        = vlTOPp->Patmos__DOT__cores_0__DOT__fetch__DOT__MemBlock__DOT__mem
        [vlTOPp->Patmos__DOT__cores_0__DOT__fetch__DOT__MemBlock__DOT__rdAddrReg];
    vlTOPp->Patmos__DOT__cores_0__DOT__fetch__DOT__MemBlock_1__DOT__mem_MPORT_1_data 
        = vlTOPp->Patmos__DOT__cores_0__DOT__fetch__DOT__MemBlock_1__DOT__mem
        [vlTOPp->Patmos__DOT__cores_0__DOT__fetch__DOT__MemBlock_1__DOT__rdAddrReg];
    ...
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___GEN_116 
        = ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_0)
            ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_1
            : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exResultDataReg_0);
    vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT___T_38 
        = ((2U & (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwReg_0))
            ? ((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__fwSrcReg_0)
                ? vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_1
                : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__memResultDataReg_0)
            : vlTOPp->Patmos__DOT__cores_0__DOT__execute__DOT__exReg_rsData_0);
    vlTOPp->Patmos__DOT__cores_0__DOT__memory__DOT___T_6 
        = (((IData)(vlTOPp->Patmos__DOT__cores_0__DOT__memory__DOT__memReg_mem_call) 
            | (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__memory__DOT__memReg_mem_ret)) 
           | (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__memory__DOT__memReg_mem_brcf));
    ...
    vlTOPp->Patmos__DOT__ramCtrl__DOT___T_29 = (7U 
                                                == (IData)(vlTOPp->Patmos__DOT__ramCtrl__DOT__transCountReg));
    vlTOPp->Patmos__DOT__ramCtrl__DOT___GEN_139 = (
                                                   (1U 
    ...
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT___GEN_102 
        = (0x1ffU & ((4U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__stateReg))
                      ? (IData)((0x7fffffffULL & ((4ULL 
                                                   + vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__transferAddrReg) 
                                                  >> 2U)))
    ...
    vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT___GEN_111 
        = (0x1ffU & ((4U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__stateReg))
                      ? (vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT___T_14 
                         >> 2U) : ((3U == (IData)(vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT__stateReg))
                                    ? (vlTOPp->Patmos__DOT__cores_0__DOT__dcache__DOT__sc__DOT___T_14 
                                       >> 2U) : ((5U 
    ...
    vlTOPp->Patmos__DOT__ramCtrl__DOT___GEN_23 = (0xffffU 
                                                  & ((0U 
                                                      == (IData)(vlTOPp->Patmos__DOT__ramCtrl__DOT__stateReg))
                                                      ? vlTOPp->Patmos__DOT__cores_0__DOT__burstBus_io_slave_M_Data
                                                      : (IData)(vlTOPp->Patmos__DOT__ramCtrl__DOT__wrBufferReg_0_data)));
